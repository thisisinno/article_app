...
urlpatterns=[
 ...
 path("api/v1/feed/",api.feed),path("api/v1/posts/",api.posts),path("api/v1/posts/<uuid:post_id>/",api.post_detail),path("api/v1/posts/<uuid:post_id>/thread/",api.thread),path("api/v1/posts/<uuid:post_id>/quote/",api.quote_post),path("api/v1/posts/<uuid:post_id>/like/",api.reaction,{"kind":"like"}),path("api/v1/posts/<uuid:post_id>/bookmark/",api.reaction,{"kind":"bookmark"}),path("api/v1/posts/<uuid:post_id>/view/",api.view),path("api/v1/posts/<uuid:post_id>/share/",api.share),
 ...
 path("api/v1/push/public-key/",api.push_public_key),path("api/v1/push/status/",api.push_status),path("api/v1/push/subscribe/",api.push_subscribe),
