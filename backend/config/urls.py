...
urlpatterns=[
 ...
 path("api/v1/conversations/",api.conversations),path("api/v1/conversations/<uuid:conversation_id>/messages/",api.messages),path("api/v1/notifications/",api.notifications),
