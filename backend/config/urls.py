...
urlpatterns=[
 ...
 path("api/v1/posts/<uuid:post_id>/comments/",api.comments),path("api/v1/comments/<uuid:comment_id>/",api.comment_detail),path("api/v1/comments/<uuid:comment_id>/replies/",api.comment_reply),path("api/v1/comments/<uuid:comment_id>/like/",api.comment_like),
